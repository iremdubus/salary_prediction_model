...
# A machine learning project for salary predictions of baseball players
# whose salary information and career statistics from 1986 are shared

# Dataset Story

# # This data set was originally obtained from the StatLib library housed at Carnegie Mellon University.
# The data set was part of the data used in the 1988 ASA Graphics Division Poster Session.
# Salary data originally came from Sports Illustrated, April 20, 1987.1986
# and career statistics were obtained from the 1987 Baseball Encyclopedia Update,
...
def check_df(dataframe, head=5):
    ...
    print("##################### Quantiles #####################")
    print(dataframe.select_dtypes(include=[int, float]).quantile([0, 0.05, 0.50, 0.95, 0.99, 1]).T)
...
rf_best_grid = GridSearchCV(rf_model, rf_params, cv=5, n_jobs=2, verbose=True).fit(X, y)
